...
namespace Mavis.MVVM
{
    ...
    /// </summary>
    public class VPFMessageBoxService : IMessageBoxService
    {
        ...
        {
            ShowMessage(message, "错误", CustomDialogIcons.Stop);
        }
        ...
        {
            ShowMessage(message, "信息", CustomDialogIcons.Information);
        }
        ...
        {
            ShowMessage(message, "警告", CustomDialogIcons.Warning);
        }
        ...
        {
            MessageBoxResult result = MessageBox.Show(message, "请确认...",
